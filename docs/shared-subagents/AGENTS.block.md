...
- Use `spec-coverage-reviewer`, `completion-claim-reviewer`, `requirements-reviewer`, `plan-reviewer`, `test-reconciliation-reviewer`, `test-adequacy-reviewer`, `closure-reviewer`, and `risk-reviewer` for review gates.
