    ...
    print(
        "\n".join(
            [
                ...
                "The template is a required structure, not a completed artifact.",
                "Filling it with meaningful content is the active Codex's responsibility.",
                "Do not refuse or stop because the template contains placeholders.",
                "1. Write the context file at the printed context_path.",
                "2. Replace every guidance line and placeholder with meaningful handoff content.",
                "3. Update the printed INDEX.md target with the printed index_entry metadata.",
                "4. Run checkpoint.py verify against the written context path.",
                "5. Do not stop after prepare output; prepare is not a completed checkpoint.",
                "",
                "After writing meaningful context from the evidence above, update INDEX.md.",
                "Do not save the template unchanged.",
                "",
            ]
        )
    )
