---
name: deep-research-prompt-export
...
```bash
python3 plugins/codex/deep-research-prompt-export/skills/deep-research-prompt-export/scripts/research_prompt.py --harness codex --problem "<research question>" --path <relative-path>
```
...
`plugins/codex/deep-research-prompt-export` with that installed plugin root.
