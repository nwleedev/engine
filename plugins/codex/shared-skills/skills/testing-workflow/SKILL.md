...
<!-- source: plugin-sources/shared-skills/skills/testing-workflow/SKILL.md -->
...
4. Output the `Testing Workflow Route` table before adding, changing, accepting, or rejecting tests.
5. Continue only through the route's next step.
6. Record unresolved routing ambiguity as `Reconciliation Required`.
