...
Role boundary: correctness, security, behavior regressions, and test adequacy remain reviewer concerns unless they directly support a maintainability/design/readability finding.
...
- defer broad correctness, security, behavior regression, and test adequacy review to reviewer unless needed as supporting evidence for maintainability/design/readability concerns
