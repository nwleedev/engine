...
- `test-reconciliation-reviewer`, `test-adequacy-reviewer`, `closure-reviewer`, and `risk-reviewer` review existing test relevance and artifact drift, newly written or modified test quality, verification-gate evidence, residual risk, rollback, fallback, and unverifiable items.
