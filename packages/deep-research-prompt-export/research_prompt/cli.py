...
def _slugify(value: str) -> str:
    ...
    return slug[:64] or "deep-research-prompt-export"
...
def build_parser() -> argparse.ArgumentParser:
    """Build the deep-research-prompt-export CLI parser."""

    parser = argparse.ArgumentParser(prog="deep-research-prompt-export")
