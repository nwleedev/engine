...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("downstream-test-contracts.md", "previous_acceptance_criteria"),
        ("downstream-test-contracts.md", "current_acceptance_criteria"),
        ("downstream-test-contracts.md", "scenario_status"),
        ("downstream-test-contracts.md", "affected_tests"),
        ("downstream-test-contracts.md", "Scenario Change Map Extension"),
        ...
        ("downstream-test-contracts.md", "coverage_id"),
        ("downstream-test-contracts.md", "reconciliation_decision_ids"),
        ("downstream-test-contracts.md", "required_test_changes"),
        ("downstream-test-contracts.md", "required_artifact_changes"),
        ("downstream-test-contracts.md", "required_new_tests"),
        ("downstream-test-contracts.md", "commands"),
        ("downstream-test-contracts.md", "evidence_ids"),
        ("downstream-test-contracts.md", "Current Requirement Coverage Extension"),
        ...
        ("downstream-test-contracts.md", "evidence_id"),
        ("downstream-test-contracts.md", "reconciliation_id"),
