...
SOURCE_ROOT = ROOT / "plugin-sources/session-memory/adapters/claude"
GENERATED_ROOT = ROOT / "plugins/claude/session-memory"
...
def test_claude_session_memory_sources_parse_as_python39() -> None:
    files = _python_files()
    assert files
...
def test_claude_session_memory_sources_do_not_use_runtime_pep604_annotations() -> None:
    failures: list[str] = []
...
def test_claude_session_memory_generated_tomli_package_exists() -> None:
