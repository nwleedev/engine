...
def _render_claude_readme(source_root: Path) -> str:
    ...
    return (
        ...
        + "- `test-reconciliation-reviewer`, `test-adequacy-reviewer`, "
        + "`closure-reviewer`, and `risk-reviewer` review existing test "
        + "relevance and artifact drift, newly written or modified test quality, "
        + "verification-gate evidence, residual risk, rollback, fallback, and "
        + "unverifiable items.\n"
        ...
        + "- Examples: `Use the test-reconciliation-reviewer subagent to review "
        + "stale test and artifact drift evidence for AC-001.` `Use the "
        + "test-adequacy-reviewer subagent to review tests for AC-001 / SCN-001.`\n"
