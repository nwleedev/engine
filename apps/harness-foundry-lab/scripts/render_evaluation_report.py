...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "- Review each finding inside the source project before editing files.",
            "- Treat missing files, registry errors, and guardrail gaps as local fixes first.",
            "",
            "## Sanitized evaluation case candidates",
            "",
            "- Consider adding an evaluation case only after the finding is reduced to public-safe synthetic content.",
            "- Candidate rule ids: "
            ...
            "- [ ] Confirm report contents are public-safe before sharing outside the source project.",
